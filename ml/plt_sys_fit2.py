...
def main(args):
    ...
    plt.plot(constraints_sys_nosysimpl[0], constraints_sys_nosysimpl[1], 'ro')
    plt.plot(constraints_nosys_nosysimpl[0], constraints_nosys_nosysimpl[1], 'ro')
    ...
    plt.axhline(y=1., color='r')
    plt.plot(constraints_sys_sysimpl[0], constraints_sys_sysimpl[1], 'ro')
    plt.plot(constraints_nosys_sysimpl[0], constraints_nosys_sysimpl[1], 'ro')
