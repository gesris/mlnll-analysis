...
def main(args):
    ...
    plt.plot(1 - constraints_sys_nosysimpl[0], 1 + constraints_sys_nosysimpl[1], 'ro')
    plt.plot(1 - constraints_nosys_nosysimpl[0], 1 + constraints_nosys_nosysimpl[1], 'ro')
    ...
    plt.axhline(y=1., color='r')
    plt.plot(1 - constraints_sys_sysimpl[0], 1 + constraints_sys_sysimpl[1], 'ro')
    plt.plot(1 - constraints_nosys_sysimpl[0], 1 + constraints_nosys_sysimpl[1], 'ro')
