...
def main(args):
    ...
    plt.axhline(y=1., xmin=0, xmax=1 - constraints_sys_nosysimpl[0], color='r')
    plt.axhline(y=1., xmin=1 + constraints_sys_nosysimpl[1], xmax=2, color='r')
    plt.axhline(y=1., xmin=0, xmax=1 - constraints_nosys_nosysimpl[0], color='r')
    plt.axhline(y=1., xmin=1 + constraints_nosys_nosysimpl[1], xmax=2, color='r')
    plt.axvline(x=1 - constraints_sys_nosysimpl[0], ymax=1., color='r')
    plt.axvline(x=1 + constraints_sys_nosysimpl[1], ymax=1., color='r')
    plt.axvline(x=1 - constraints_nosys_nosysimpl[0], ymax=1., color='r')
    plt.axvline(x=1 + constraints_nosys_nosysimpl[1], ymax=1., color='r')
    plt.plot(1 - constraints_sys_nosysimpl[0], 1, 'rx')
    plt.plot(1 + constraints_sys_nosysimpl[1], 1,  'rx')
    plt.plot(1 - constraints_nosys_nosysimpl[0], 1, 'rx')
    plt.plot(1 + constraints_nosys_nosysimpl[1], 1, 'rx')
    ...
    plt.axhline(y=1., xmin=0, xmax=1 - constraints_sys_sysimpl[0], color='r')
    plt.axhline(y=1., xmin=1 + constraints_sys_sysimpl[1], xmax=2, color='r')
    plt.axhline(y=1., xmin=0, xmax=1 - constraints_nosys_sysimpl[0], color='r')
    plt.axhline(y=1., xmin=1 + constraints_nosys_sysimpl[1], xmax=2, color='r')
    plt.axvline(x=1 - constraints_sys_sysimpl[0], ymax=1., color='r')
    plt.axvline(x=1 + constraints_sys_sysimpl[1], ymax=1., color='r')
    plt.axvline(x=1 - constraints_nosys_sysimpl[0], ymax=1., color='r')
    plt.axvline(x=1 + constraints_nosys_sysimpl[1], ymax=1., color='r')
    plt.plot(1 - constraints_sys_sysimpl[0], 1, 'rx')
    plt.plot(1 + constraints_sys_sysimpl[1], 1,  'rx')
    plt.plot(1 - constraints_nosys_sysimpl[0], 1, 'rx')
    plt.plot(1 + constraints_nosys_sysimpl[1], 1, 'rx')
