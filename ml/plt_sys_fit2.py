...
def main(args):
    ...
    plt.plot([0], [0], color='#ff7f0e', label="$\mathsf{\mu_{}}$ = 1.00 (-{:.3f} +{:.3f})".format('\mathrm{stat. + sys.}', constraints_sys_nosysimpl[1], constraints_sys_nosysimpl[0]))
    plt.plot([0], [0], color='#1f77b4', label="$\mu_{}$     = 1.00 (-{:.3f} +{:.3f})".format('\mathrm{stat.}', constraints_nosys_nosysimpl[1], constraints_nosys_nosysimpl[0]))
    ...
    plt.plot([0], [0], color='#ff7f0e', label="$\mu_{}$ = 1.00 (-{:.3f} +{:.3f})".format('\mathrm{stat. + sys.}', constraints_sys_sysimpl[1], constraints_sys_sysimpl[0]))
    plt.plot([0], [0], color='#1f77b4', label="$\mu_{}$     = 1.00 (-{:.3f} +{:.3f})".format('\mathrm{stat.}', constraints_nosys_sysimpl[1], constraints_nosys_sysimpl[0]))
    plt.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc=3, ncol=1, mode="expand", borderaxespad=0., prop={'size': 14})
