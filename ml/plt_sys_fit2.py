...
def main(args):
    ...
    plt.plot([0], [0], color='k', label="stat + sys:    +{:.3f}/-{:.3f}\n".format(constraints_sys_nosysimpl[0], constraints_sys_nosysimpl[1]))
    ...
    plt.axhline(y=1., color='r')
    plt.plot([0], [0], color='k', label="stat + sys:    +{:.3f}/-{:.3f}\n".format(constraints_sys_sysimpl[0], constraints_sys_sysimpl[1]))
