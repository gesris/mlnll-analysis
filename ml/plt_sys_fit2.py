...
def main(args):
    ...
    vscale = 1 / 4.5
    plt.plot([0, 1 - constraints_sys_nosysimpl[0]], [1, 1], '#d62728')
    plt.plot([1 + constraints_sys_nosysimpl[1], 2], [1, 1], '#d62728')
    plt.plot([0, 1 - constraints_nosys_nosysimpl[0]], [1, 1], '#d62728')
    plt.plot([1 + constraints_nosys_nosysimpl[1], 2], [1, 1], '#d62728')
    ...
    vscale = 1 / 4.5
    plt.plot([0, 1 - constraints_sys_sysimpl[0]], [1, 1], '#d62728')
    plt.plot([1 + constraints_sys_sysimpl[1], 2], [1, 1], '#d62728')
    plt.plot([0, 1 - constraints_nosys_sysimpl[0]], [1, 1], '#d62728')
    plt.plot([1 + constraints_nosys_sysimpl[1], 2], [1, 1], '#d62728')
