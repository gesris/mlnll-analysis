...
def plot(signal, background, category, bins, bins_center):
    ...
    plt.hist(bins_center, weights= background[1], bins= bins, histtype="step", lw=2, ls="--", color="C2")
    plt.hist(bins_center, weights= background[2], bins= bins, histtype="step", lw=2, ls=":", color="C3")
    plt.plot([0], [0], ls="-", lw=2, color="C0", label="Htt")
    plt.plot([0], [0], ls="-", lw=2, color="C1", label="Ztt")
    plt.plot([0], [0], ls="--", lw=2, color="C2", label="W")
    plt.plot([0], [0], ls=":", lw=2, color="C3", label="ttbar")
