...
def plot(signal, background, category, bins, bins_center):
    ...
    plt.hist(bins_center, weights= background[1], bins= bins, histtype="step", lw=2, ls="--", color="C1")
    plt.hist(bins_center, weights= background[2], bins= bins, histtype="step", lw=2, ls=":", color="C1")
